...
const Navbar = () => {
  ...
  <a className="navbar-brand" href="#">Stack Overflow Clone</a>
    ...
    <ul className="navbar-nav mr-auto">
      ...
      <li className="nav-item dropdown">
        ...
        <div className="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a className="dropdown-item" href="#">Hacking</a>
          <div className="dropdown-divider"></div>
          <a className="dropdown-item" href="#">Web Development</a>
        </div>
      </li>
      <li className="nav-item">
        <a className="nav-link disabled" href="#">Click here for free bitcoin</a>
      </li>
    </ul>
